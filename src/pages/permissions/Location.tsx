...
type LocationProps = NativeStackNavigationProp<RootStackParamList, 'LocationPermission'>

const Location = ({ route: { params: { route } }, navigation }: { route: { params: { route: 'Login' | 'Registration' } }, navigation: LocationProps }) => {
    const { saveValue } = useAsyncStorage('location');
    const refRBSheet: any = useRef(null);

    const { getStoredValue: getMicrophone } = useAsyncStorage('microphone');

    const getNextPage = async () => {
        saveValue(await getLocation());
            ...
            >
                <ScrollView style={styles.innerContainer}>
                    <View style={styles.innerImageContainer}>
                        <Image source={require('../../assets/LocationBottom.png')} style={[styles.image, styles.innerImage]} />
                    </View>
